...
#define USE_IF2IP
   ...
   namespace detail {
      ...
      socket_t BufferStream::socket() const {
         return 0;
      }
   ...
   void Server::set_tcp_nodelay(bool on) {
      tcp_nodelay_ = on;
   }
   ...
   Error ClientImpl::get_last_error() const {
      return error_;
   }
   ...
   void ClientImpl::set_interface(const char* intf) {
      interface_ = intf;
   }
   ...
   namespace detail {
      ...
      socket_t SSLSocketStream::socket() const {
         return sock_;
      }
   ...
   Result Client::Get(const char* path) {
   ...
   Result Client::Head(const char* path) {
   ...
   Result Client::Delete(const char* path) {
   ...
   Result Client::Options(const char* path) {
